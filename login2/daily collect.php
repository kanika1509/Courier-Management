...
$raw_results=mysql_query("select * from users INNER JOIN rate where users.city=rate.city1 and users.dcity=rate.city2") or die("failed to query database".mysql_error());
